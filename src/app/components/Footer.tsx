...
<main className=" bg-[#fdfdfd] min-h-screen  px-4">
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    {[
      ...
      >
        <h3 className="text-sm font-semibold text-[#006d77] mb-2">
          Blog Articles
        </h3>
        <h2 className="text-[1.2rem] font-bold hover:text-[#005f73] text-gray-800 mb-4">{article.title}</h2>
      ...
      {/* Footer Section */}
      <footer className="mt-36 bg-[#006d77] text-white py-8">
        <div className="text-center">
          <p className="text-lg font-semibold">© 2024 Syed Fawwad Ali</p>
