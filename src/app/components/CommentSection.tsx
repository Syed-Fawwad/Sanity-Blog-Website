  ...
  return (
    <div className="max-w-2xl mx-auto my-8 p-6 bg-white shadow-lg rounded-lg">
      ...
      <form onSubmit={handlesubmit} className="mb-6">
        ...
        <button
          type="submit"
          className="mt-4 bg-[#006d77] border-[#005f73] border-[2px] text-white px-6 py-2 rounded-md hover:bg-white hover:text-black hover:border-[#005f73]hover:border-[2px] transition duration-200"
        >
          Submit
        </button>
      </form>
